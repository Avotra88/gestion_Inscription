...
urlpatterns = [
    ...
    path('confirm_delete/<int:inscription_id>/', inscriptions_views.confirm_delete, name='confirm_delete'),  # Modifiez ici pour utiliser inscriptions_views
    ...
    path('users/', inscriptions_views.user_list, name='user_list'),
]
